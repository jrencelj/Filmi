...
class KomentarIMDB:
    ...
    def pridobi_tezo_komentarja(div_znacka):
        ...
        if div_moc is None: return None
    ...
    def pridobi_vsebino_komentarja(div_znacka_komentar):
        ...
        div_vsebina = div_znacka_komentar.find_all('div', class_ = 'text show-more__control')
        div_vsebina = None if div_vsebina == [] else div_vsebina[0]
        if div_vsebina is None: return None
        regex_html = r'<[\w]{0,2}[\/]?>'
        ...
        if komentar_html is None: return None
        regex_html = r'<[^>]*>'
    ...
    def pridobi_naslov_komentarja(div_znacka_komentar):
        ...
        if a_naslov is None: return None
    ...
    def pridobi_oceno(div_znacka_komentar):
        ...
        span_ocena = div_znacka_komentar('span', class_ = 'rating-other-user-rating')
    ...
    def pridobi_imdb_id_komentarja(div_znacka_komentar):
        ...
        if a_imdb_id is None: return None
